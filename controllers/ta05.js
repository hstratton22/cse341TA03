...
exports.postStyle = (req, res, next) => {
    ...
    res.redirect('/teamActivities/ta05'); // For now, you need to redirect to view the changes without manually refreshing.
};
...
exports.resetSession= (req, res, next) => {
    if (req.body.reset === 'true') {
        req.session.destroy(() => {
            res.redirect('/teamActivities/ta05'); // Redirect must be passed through the callback   
        })
    } else {
